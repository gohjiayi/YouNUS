  ...
  <div class="content pl-4">
    ...
    <v-dialog v-model="showTaskModal" width="900px">
      <div class="create-task pa-2" style="background:white">
        ...
        <v-card class="my-5 pb-5" color="basil">
          ...
          <v-tabs-items v-model="tab">
            <v-tab-item v-for="item in items" :key="item">
              <v-card
                class="comment-content mt-3"
                v-if="item === 'Comments'"
                color="basil"
                flat
              >
                <v-card-text class="comment-title"
                  >Comments <span>{{getTitalNumberOfCommit()}}</span></v-card-text
                >

                <div class="comments">
                  <div class="comment-wrap">
                    <div class="comment-block">
                      <input v-model="comment" type="text" placeholder="Write your comment here">
                    </div>
                  </div>

                  <template v-for="comment in comments">
                  <div v-if="comment.taskId === taskId" class="comment-wrap" :key="comment.id">
                    <div class="comment-block">
